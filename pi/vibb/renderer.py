"""The renderer axis + the vibb-sonos sidecar client (stdlib).
...
SONOS_API = os.environ.get("VIBB_SONOS_API", "http://127.0.0.1:3681")
...
class SidecarDown(OSError):
    """vibb-sonos itself is unreachable — freeze, never zero, and never
